...
- mooncakes パッケージ `Mairzzcllo/moonbit_sqlc_plugin/runtime` **0.1.6**
...
```bash
moon add Mairzzcllo/moonbit_sqlc_plugin@0.1.6   # アップグレード
...
| リソース | リンク |
|----------|--------|
| クイックスタート | [docs/quickstart.ja.md](docs/quickstart.ja.md) · [English](docs/quickstart.md) · [中文](docs/quickstart.zh.md) |
| Runtime API | [docs/runtime-api.ja.md](docs/runtime-api.ja.md) · [English](docs/runtime-api.md) · [中文](docs/runtime-api.zh.md) |
| サンプル | [examples/README.ja.md](examples/README.ja.md) · [English](examples/README.md) · [中文](examples/README.zh.md) |
